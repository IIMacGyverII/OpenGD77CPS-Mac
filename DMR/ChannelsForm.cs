...
namespace DMR
{
	public class ChannelsForm : DockContent, IDisp, ISingleRow
	{
		...
		private void EnsureChannelFilterBox()
		{
			...
			this.lblChannelsGridHint.Text = "D=blue digital · A=amber analog · G=green · P=orange · A(gray)=all-call · F2/click opens editor · Ctrl+F filter · Ctrl+Shift+F tree · Del delete · blue = active · sorts";
