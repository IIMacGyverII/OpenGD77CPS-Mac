		...
		public AndroidWorkflowForm()
		{
			...
			Label intro = new Label
			{
				...
				Text =
					...
					"6. F7 opens codeplug health report (scrolls to first warning). After import: click amber status, Health ⚠ (F7) footer, batch dialog button, or left status bar link.\n" +
