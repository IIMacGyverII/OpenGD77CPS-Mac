		...
		public AndroidWorkflowForm()
		{
			...
			Label intro = new Label
			{
				...
				Text =
					...
					"6. Pending diff: Ctrl+D when pending; center ▶ Review diff ⚠ / ▶ Export ⚠ links; left status after pull; Review/Import/Export/Backup ⚠ toolbar and File menu; F8/Studio footers and report link. Ctrl+I/Ctrl+E offer Review diff first; export also warns on overwrite; left status and batch note when cues clear.\n" +
