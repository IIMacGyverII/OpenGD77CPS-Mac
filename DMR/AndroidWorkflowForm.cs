		...
		public AndroidWorkflowForm()
		{
			...
			Label intro = new Label
			{
				...
				Text =
					...
					"6. After pull: left status bar shows pending channel changes — click it to open Review diff (Ctrl+D). Toolbar/menu Review diff ⚠ (View) also opens F8 when changes need review. In F8/Studio: click amber status or Review diff ⚠ footer.\n" +
