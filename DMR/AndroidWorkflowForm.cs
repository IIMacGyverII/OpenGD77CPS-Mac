		...
		public AndroidWorkflowForm()
		{
			...
			Label intro = new Label
			{
				...
				Text =
					...
					"6. F7 opens codeplug health report (scrolls to first warning). After import: click the report link, amber status, Health ⚠ footer, batch dialog, or left status bar link.\n" +
