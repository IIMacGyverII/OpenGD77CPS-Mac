...
**Shipped:** v1.4.5 — Right-click any contact DMR ID field → **"Look up on RadioID.net"** opens `https://www.radioid.net/database/view?id={DMR_ID}` in the default browser via `Process.Start`.
